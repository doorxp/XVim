...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *modeString;
...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *argumentDisplayString;

// Returns the current stack of arguments (eg. "a10d...")
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *argumentString;

// Returns the context yank register if any
@property (NS_NONATOMIC_IOSONLY, readonly, strong) XVimRegister *yankRegister;

// Returns the context numeric arguments multiplied together
@property (NS_NONATOMIC_IOSONLY, readonly) NSUInteger numericArg;

// Returns the context
@property (NS_NONATOMIC_IOSONLY, readonly, strong) XVimEvaluatorContext *context;

// Equivalent to [[self context] copy]
@property (NS_NONATOMIC_IOSONLY, readonly, strong) XVimEvaluatorContext *contextCopy;

// Clears the context and returns self, useful for escaping from operators
@property (NS_NONATOMIC_IOSONLY, readonly, strong) XVimEvaluator *withNewContext;
