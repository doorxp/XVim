...
@property (unsafe_unretained) XVimRegister *playbackRegister;
@end
...
- (instancetype)init
{
	if (!(self = [super initWithContext:[[XVimEvaluatorContext alloc] init]])) return nil;
	return self;
}
	 
- (instancetype)initWithContext:(XVimEvaluatorContext*)context
{
	if (!(self = [super initWithContext:context])) return nil;
	return self;
}
		...
		playbackRegister:(XVimRegister*)xregister
{
    ...
    if (self) {
		self.playbackRegister = xregister;
    }
    return self;
}
