...
- (instancetype)initWithKeyCode:(unichar)keyCode
		modifierFlags:(NSUInteger)modifierFlags NS_DESIGNATED_INITIALIZER;
...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSEvent *toEvent;

// Creates the selector string from this key stroke
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *toSelectorString;
...
@property (NS_NONATOMIC_IOSONLY, readonly) SEL selector;
