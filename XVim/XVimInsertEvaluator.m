...
@property (nonatomic, strong) NSArray *cancelKeys;
@property (nonatomic, strong) NSArray *movementKeys;
@end
		  ...
		  oneCharMode:(BOOL)oneCharMode
{
    ...
    if (self) {
        ...
        self.cancelKeys = @[[NSValue valueWithPointer:@selector(ESC:)],
                       [NSValue valueWithPointer:@selector(C_LSQUAREBRACKET:)],
                       [NSValue valueWithPointer:@selector(C_c:)]];
        self.movementKeys = @[[NSValue valueWithPointer:@selector(Up:)],
