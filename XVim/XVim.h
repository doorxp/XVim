...
@property (strong) XVimRegister *repeatRegister;
@property (strong) XVimRegister *recordingRegister;
@property (strong) XVimRegister *lastPlaybackRegister;

- (XVimKeymap*)keymapForMode:(int)mode;
- (XVimRegister*)findRegister:(NSString*)name;
- (void)parseRcFile;
@property (NS_NONATOMIC_IOSONLY, readonly, strong) XVimHistoryHandler *exCommandHistory;
@property (NS_NONATOMIC_IOSONLY, readonly, strong) XVimHistoryHandler *searchHistory;
- (void)ringBell;
