...
- (void)handleWarningInFunction:(id)arg1 fileName:(id)arg2 lineNumber:(long long)arg3 messageFormat:(id)arg4 arguments:(struct __va_list_ *)arg5;
- (void)handleWarningInMethod:(SEL)arg1 object:(id)arg2 fileName:(id)arg3 lineNumber:(long long)arg4 messageFormat:(id)arg5 arguments:(struct __va_list_ *)arg6;
- (void)handleFailureInFunction:(id)arg1 fileName:(id)arg2 lineNumber:(long long)arg3 messageFormat:(id)arg4 arguments:(struct __va_list_ *)arg5;
- (void)handleFailureInMethod:(SEL)arg1 object:(id)arg2 fileName:(id)arg3 lineNumber:(long long)arg4 messageFormat:(id)arg5 arguments:(struct __va_list_ *)arg6;
@end
...
- (void)printf:(const char *)arg1 arguments:(struct __va_list_ *)arg2;
...
- (void)setMacroNamesAndValues:(id)arg1 arguments:(struct __va_list_ *)arg2;
...
+ (id)dvt_errorWithPOSIXErrorCode:(int)arg1 messageFormat:(id)arg2 arguments:(struct __va_list_ *)arg3;
...
- (BOOL)dvt_writeFormat:(id)arg1 arguments:(struct __va_list_ *)arg2;
